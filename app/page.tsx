...
const whyItems = [
  "С 2016 года — опыт, который чувствуется в организации, мастерах и отношении к клиенту.",
  "Спокойная атмосфера с мягкой beauty-эстетикой, чистотой и дружелюбным общением.",
  "Аккуратность в деталях: форма, покрытие, гигиена и комфорт важны так же, как красивый результат.",
  "Можно спокойно уточнить детали, отправить референс и выбрать удобное время.",
];
    ...
    <>
      ...
      <main>
        ...
        <Section
          id="services"
          eyebrow="услуги"
          title="Выберите уход, который подходит именно вам"
          description="Маникюр, покрытие, дизайн или наращивание — выберите формат, а администратор уточнит детали, время и итоговую стоимость при записи."
        >
        ...
        <Section id="about" eyebrow="почему love nails" title="Ногтевая студия, куда легко прийти и хочется вернуться">
        ...
        <Section
          ...
          className="bg-[#fff9f4]"
          eyebrow="работы"
          title="Работы в мягкой, чистой эстетике"
          description="Нюд, френч, аккуратная форма и деликатный дизайн — мягкое направление студии без визуального перегруза."
        >
