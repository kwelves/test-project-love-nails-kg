...
export function TeamCard({ member, onOpen }: TeamCardProps) {
  return (
    <motion.article
      ...
      className="group flex h-full min-w-[17.5rem] snap-start flex-col overflow-hidden rounded-[1.75rem] border border-border/80 bg-card shadow-[0_18px_48px_rgb(35_33_36_/_0.07)] sm:min-w-0"
    >
